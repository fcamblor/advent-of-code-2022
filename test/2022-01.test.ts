...
import {D01_extractElfFood} from "../src/2022-01";
...
/*
test("Q1 Sample", () => {
    expect(`an imported sample ${D01_Q1_SAMPLE} from 2022-01.inputs.ts which is then processed by src/2022-01.ts functions`).toEqual(`an expected result from 2022-01.inputs.ts`);
})
